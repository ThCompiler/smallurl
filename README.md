...
Также он доступен на [Github Pages](https://thcompiler.github.io/smallurl/3/#), но не в полном объёми, 
т.к. акшен генерирующий отчёт не умеет коректно работать при передачи нескольких результатов выполнения тестов. 
