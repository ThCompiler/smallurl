...
// GetLogger получает из контекста запроса созданного миделварой RequestLogger логгера.
// Если он отсутствует в контексте, то возвращается [logger.DefaultLogger].
